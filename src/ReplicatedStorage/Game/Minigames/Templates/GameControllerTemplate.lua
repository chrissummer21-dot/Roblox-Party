-- GameControllerTemplate (contrato base)
local GameController = {}

function GameController.GetMeta()
    return { id = "Template", displayName = "Template", recommendedPlayers = "4-8", version = "0.1.0", tags = {}, weight = 1 }
end
...
function GameController.Start()
    -- Inicia la lÃƒÂ³gica del minijuego
end
